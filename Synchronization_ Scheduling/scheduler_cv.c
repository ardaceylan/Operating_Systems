...
void schedule_rr_cv(pthread_cond_t* cond, int processor_id, int outmode, struct timeval start_time, pthread_mutex_t* finished_lock, struct node** finished_list, pthread_mutex_t* lock, struct node** ready_queue_head, int q){
...
void schedule_fcfs_cv(pthread_cond_t* cond, int processor_id, int outmode, struct timeval start_time, pthread_mutex_t* finished_lock, struct node** finished_list, pthread_mutex_t* lock, struct node** ready_queue_head){
...
void schedule_sjf_cv(pthread_cond_t* cond, int processor_id, int outmode, struct timeval start_time, pthread_mutex_t* finished_lock, struct node** finished_list, pthread_mutex_t* lock, struct node** ready_queue_head){
